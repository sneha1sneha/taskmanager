...
// using grid api
  ...
  columnDefs= [
    ...
    { headerName: 'Task Name', field: 'task_name', filter: true, floatingFilter: true },
    { headerName: 'Description', field: 'description',filter: true, floatingFilter: true },
    { headerName: 'Project Name', field: 'project_name' ,filter: true, floatingFilter: true},
    { headerName: 'Status', field: 'status_type' ,filter: true, floatingFilter: true},
